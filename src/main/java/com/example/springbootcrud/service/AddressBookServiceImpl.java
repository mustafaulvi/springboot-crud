...
import com.example.springbootcrud.repository.AddressBookRepository;
...
public class AddressBookServiceImpl implements AddressBookService {
    ...
    public AddressBook updateAddressBook(AddressBook addressBook) {
        ...
        if (addressBookDb.isPresent()) {
            ...
            addressBookUpdated.setImportantDates(addressBook.getImportantDates());
            addressBookUpdated.setPersonGroups(addressBook.getPersonGroups());
